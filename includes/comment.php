...
$a=mysqli_query("INSERT INTO `{$db_name}`.`comments` (`noidung`, `ngaydang`, `manga_id`, `user_id`) VALUES ('{$noidung}', '{$ngaydang}', '{$id}', '{$user_id5}')");
?>
<?php
$rows_per_page = 5;
...
$sql_memdata2 = @mysqli_query($con, "SELECT username,avatar,sex FROM members WHERE id='{$user_id10}'");
...
<a href="user?username=<?php echo $user2['username']; ?>" class="thumbnail" ><img src="<?php echo avatar($user['avatartype'],$user['avatar'],$user['sex'],130); ?>"></a>
