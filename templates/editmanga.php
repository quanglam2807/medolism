<form class="form-horizontal" action="editmanga?act=do&&id=<? echo $id; ?>" method="post" enctype="multipart/form-data">
...
<div class="control-group">                  
	...
	<div class="controls docs-input-sizes">                  
		<input type="text" name="tenkhac" value="<? echo $tenkhac; ?>"> 
...
<div class="control-group">                  
	...
	<div class="controls docs-input-sizes">                  
		<input type="text" name="tacgia" value="<? echo $tacgia; ?>"> 
	</div>                                                                  
</div>  
<div class="control-group">                  
	<label>Nguồn <font style="color:red;">*</font>:</label>              
	<div class="controls docs-input-sizes">                  
		<input type="text" name="nguon" value="<? echo $nguon; ?>"> 
		<p class="help-block">Ngăn cách bằng dấu dấu chấm phẩy <b><font color="red">;</font></b> .</p>		
	</div>                                                                  
</div>  
<div class="control-group">                  
	...
	<div class="controls docs-input-sizes">                  
		<input type="text" name="congtac" value="<? echo $congtac; ?>"> 
...
<div class="control-group">                  
	...
	<div class="controls docs-input-sizes">                  
		<textarea maxlength="1000" name="chuthich" class="xxlarge" style="background-color: white;"><? echo $chuthich; ?></textarea>
	</div>                                                                  
</div>	
<div class="control-group">                  
...
<div class="control-group">                  
	...
	<input type="hidden" name="xxx" value="<? echo $xxx; ?>" />			
...
?>		
		<div style="float:left;width:150px;"><input type="checkbox" name="cats[]" value="<? echo $cats['id']; ?>" <? if (in_array($cats['id'],$idCheck)) { ?>checked<? } ?> /> <? echo $cats['name']; ?></div>
<?
}
?>
		</div> 
