...
<script src="jslang/<? echo $usinglang; ?>.js"></script>    
...
<script type="text/javascript" src="js/ui.js"></script>
	<title>Medolism - <? echo $lang_page_title; ?></title>      
</head>  	
<body>                                                                                                                                                                                                                                                                                                                                                                                 
		<a name="top"></a>   
    <div class="navbar">
						...
						<div style="text-align: right; padding-bottom: 5px; width: 600px;" id="chosesearch">
							...
							<div class="search_inside">           
								<div id="search_box">	                                                                                                                                            
									...
									<input type="text" name="ajaxfind" id="topmenu_search_query" search-url="ajax/headfind/1.php" search-type="1" maxlength="60" placeholder="<? echo $lang_search_value; ?>">                  
								</div>                                                                                                                                                              
							</div>                                                                                                                                                                 
						</div> 
 </div>                                                                                              
<ul class="breadcrumb">											
  <li><i class="icon-home"></i> <a href="index"><? echo $lang_home; ?></a> <span class="divider">/</span></li>	
  <li class="active"><? echo $lang_page_title; ?></li>								
</ul>
<?																
if ($error_warn==1) {
?>
<div class="alert alert-error fade in">
<a class="close" href="#"  data-dismiss="alert" >&times;</a><? echo $error_warn_in; ?>
</div>
<?
}
if ($colummn==1) {
...
?>
<div style="height: 380px; background: url('<? echo $coverimg; ?>') no-repeat scroll 0pt 0pt rgb(255, 255, 255);" class="introduce">
<?
}
