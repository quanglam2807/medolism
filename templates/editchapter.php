...
<div class="control-group">                  
	...
	<div class="controls docs-input-sizes">                  
		<input type="text" name="chap" value="<? echo $chap; ?>"> 
...
<div class="control-group">                  
	...
	<div class="controls docs-input-sizes">                  
		<input type="text" name="bosung" maxlength="255" value="<? echo $bosung; ?>"> 
...
<div class="control-group">                  
	...
	<div class="controls docs-input-sizes">                  
		<input type="text" name="download" value="<? echo $download; ?>"> 
	</div>                                                                  
</div>  
<div class="control-group">                  
...
<div class="btn-group" style="margin-bottom:10px;">
    ...
    <a href="editchapter?way=2&&id=<? echo $chapter_id; ?>" class="btn btn-small">Chế Độ Giản Hoá</a>
</div>  
		<script type="text/javascript" src="js/myscript.js"></script>
		<textarea style="background-color: white; width: 500px; height: 300px;" id="noidung" name="noidung" class="ckeditor"><? echo $noidung; ?></textarea>
</div>
<?
}
if ($detectway==2){
...
<div class="btn-group" style="margin-bottom:10px;">
    <a href="editchapter?way=1&&id=<? echo $chapter_id; ?>" class="btn btn-small">Chế Độ Đầy Đủ</a>
    <a href="#" class="btn btn-small active">Chế Độ Giản Hoá</a>
</div>         
		<textarea style="background-color: white; width: 470px; height: 196px;" class="xxlarge" name="noidung"><? echo $noidung; ?></textarea>
