...
<div class="control-group">
	...
	<div class="controls docs-input-sizes">
		<input type="text" name="tenkhac" value="<?php echo $_POST['tenkhac']; ?>">
...
<div class="control-group">
	...
	<div class="controls docs-input-sizes">
		<input type="text" name="tacgia" value="<?php echo $_POST['tacgia']; ?>">
	</div>
</div>
<div class="control-group">
	<label>Nguồn <font style="color:red;">*</font>:</label>
	<div class="controls docs-input-sizes">
		<input type="text" name="nguon" value="<?php echo $_POST['nguon']; ?>">
		<p class="help-block">Ngăn cách bằng dấu dấu chấm phẩy <b><font color="red">;</font></b> .</p>
	</div>
</div>
<div class="control-group">
	...
	<div class="controls docs-input-sizes">
		<input type="text" name="congtac" value="<?php echo $_POST['congtac']; ?>">
...
<div class="control-group">
	...
	<div class="controls docs-input-sizes">
		<textarea maxlength="1000" name="chuthich" class="xxlarge" style="background-color: white;"><?php echo $_POST['chuthich']; ?></textarea>
	</div>
</div>
<div class="control-group">
...
?>
		<div style="float:left;width:150px;"><input type="checkbox" name="cats[]" value="<?php echo $cats['id']; ?>" /> <?php echo $cats['name']; ?></div>
<?php
}
?>
		</div>
