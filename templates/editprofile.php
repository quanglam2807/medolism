...
<button type="button" value="1" class="btn btn-small<?php if ($user['sex']==1) { echo ' btn-primary active'; } ?>" data-toggle="button"><? echo $lang_male; ?></button>
<button type="button" value="2" class="btn btn-small<?php if ($user['sex']==2) { echo ' btn-primary active'; } ?>" data-toggle="button"><? echo $lang_female; ?></button>
<button type="button" value="0" class="btn btn-small<?php if ($user['sex']==0) { echo ' btn-primary active'; } ?>" data-toggle="button"><? echo $lang_othersex; ?></button>
</div>
<input type="hidden" name="sex" value="<? echo $user['sex']; ?>" />
<?php
echo "	</div>";
echo "</div>";  
echo "<div class=\"control-group\">                                                                                                        ";
