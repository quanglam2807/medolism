...
<li class="firsttabs"><a href="profile"><?php echo $lang_profile; ?></a></li>
<li><a href="mailpass"><?php echo $lang_emailandpass; ?></a></li>
<li class="active"><a href="avatar"><?php echo $lang_avatar; ?></a></li>
</ul>
<div class="pill-content">
<div class="active">
<div class="form-horizontal" >
<div class="control-group">
<label><?php echo $lang_current_avatar; ?>:</label>
<div class="controls docs-input-sizes"> 
<ul>
<a>
<img src="<?php echo $user['avatar']; ?>" class="thumbnail" style="max-height: 200px;">
</a>
</ul>
</div>
</div>
...
<h2 style="padding-left: 10px;"><?php echo $lang_avatar_step." 2: "; ?>
<small><?php echo $lang_edit_avatar; ?></small>
</h2> 
</div>
...
<a id="crop" class="btn btn-primary" href="#avatar_modal" data-toggle="modal"><?php echo $lang_finish_avatar; ?></a>                                      
<button id="restore" class="btn"><?php echo $lang_restore_image; ?></button> 
<div id="avatar_modal" class="modal hide fade">
<div class="modal-header">
<a class="close" data-dismiss="modal">&times;</a>
<h3><?php echo $lang_confirm; ?></h3>
</div>
...
<p><?php echo $lang_avatar_guide; ?></p>
</div>
<div class="modal-footer">
<a data-dismiss="modal" class="btn" href="#"><?php echo $lang_cancel; ?></a>
<input type="submit" name="submit" value="<?php echo $lang_confirm; ?>" class="btn btn-primary" ></input>
</div>
</form>
</div>
</div>                                                             
