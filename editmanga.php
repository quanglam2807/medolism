...
if ($_POST['submit']) {
	...
	if ((!$_POST['name']) || (!$_POST['tacgia']) || (!$_POST['status']) || (!$_POST['cats']) || (!$_POST['chuthich']) || (($_POST['imgmode']==2) && (($row['imgmode']==2) || ($row['imgmode']==1)) && ((!$_POST['smallimg']) || (!$_POST['bigimg']))) || (($row['imgmode']==2) && ($_POST['imgmode']==1) && ((!$_FILES["bigimg"]["name"]) || (!$_FILES["smallimg"]["name"])))) {
	$error_warn=1;
